                ...
                <div className="flex flex-col gap-4 mb-2">
                    <p className="flex flex-col gap-2 text-sm">
                        ...
                        <span className="text-xs sm:text-sm">
                            Hey, I am Arul Valan Anto — Full Stack Developer and
                            tech blogger. I have more than 5 years of experience
                            in coding under my belt. My playground? Crafting
                            sleek and savvy web applications that make users go
                            &ldquo;Wow!&rdquo;.
                        </span>
                    </p>
                    <p className="flex flex-col gap-2 text-sm">
                    ...
                    {showMore && (
                        <p className="flex flex-col gap-2 text-sm">
                            ...
                            <span className="text-xs sm:text-sm">
                                In my free time, I like playing video games and
                                reading books. One of my favorite books is{' '}
                                <span className="font-semibold">
                                    &ldquo;The Alchemist.&rdquo;
                                </span>{' '}
                                I also enjoy writing technical articles, where I
                                share what I know, on platforms like Medium and
                                Hackernoon.
                            </span>
                        </p>
                    )}
                    ...
                    {showMore && (
                        <p className="flex flex-col gap-2 text-sm">
                            ...
                            <span className="text-xs sm:text-sm">
                                Impactful, purposeful work with a diverse team
                                of talented people.
                            </span>
                        </p>
                    )}
