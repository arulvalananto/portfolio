...
const Annals = () => {
  return (
    <Link
      href="/work/annals"
      className="custom-cursor-view-more col-span-12 md:col-span-6 xl:col-span-4 row-span-2 md:row-span-4 xl:row-span-6 bg-[#0F172A] rounded-2xl border-4 border-black p-3 flex flex-col items-center gap-10 xl:gap-[18px] overflow-hidden group select-none"
    >
      <Image
