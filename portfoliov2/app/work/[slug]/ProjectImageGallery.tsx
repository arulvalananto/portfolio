...
const ProjectImageGallery: React.FC<ProjectImageGalleryProps> = ({
  ...
  return (
    <div className="mt-10 md:mt-20 px-5 md:p-0 w-full md:w-[800px] md:max-w-[800px] lg:w-[1280px] lg:max-w-[1280px] m-auto grid grid-cols-12 auto-rows-[360px] lg:auto-rows-[300px] gap-2">
      <div
